...
{
	partial class CreatureMultipleSelectForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.DragLbl.Dock = System.Windows.Forms.DockStyle.Top;
			this.DragLbl.Location = new System.Drawing.Point(0, 0);
			...
			this.DragLbl.DragOver += new System.Windows.Forms.DragEventHandler(this.DragLbl_DragOver);
			this.DragLbl.DragDrop += new System.Windows.Forms.DragEventHandler(this.DragLbl_DragDrop);
			// 
			...
			this.Name = "CreatureMultipleSelectForm";
			this.ShowIcon = false;
